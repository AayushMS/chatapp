...
SECRET_KEY = 'django-insecure-n77@&3^wzxn))n$#k$%x2i%e7#)-=uko(k&42avaqr(w-#-_l5'
...
CHANNEL_REDIS_RETRY_INTERVAL = 1  # Retry interval in seconds
CHANNEL_REDIS_RETRY_TIMEOUT = 30  # Retry timeout in seconds
